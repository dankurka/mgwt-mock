...
public class MockAnimationEndEvent extends AnimationEndEvent {
  ...
  private static com.google.gwt.event.dom.client.DomEvent.Type<AnimationEndHandler> MOCKTYPE = new Type<AnimationEndHandler>("animationEnd", new MockAnimationEndEvent());
